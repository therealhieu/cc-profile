...
- [ ] **Step 1: Write failing unit test for env options helper**
...
fn env_options_include_sorted_env_keys_and_back() {
    ...
    assert_eq!(env_options(&config), vec!["HTTP_PROXY", "HTTPS_PROXY", "Back"]);
}
```
...
- [ ] **Step 3: Implement remaining interactive flows**
